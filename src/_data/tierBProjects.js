module.exports = [
  {
    ...
    links: [
      {
        label: "Frontend",
        url: "https://github.com/osmarpetry/lion-fe",
      },
      {
        label: "Backend",
        url: "https://github.com/osmarpetry/lion-be",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/osmarpetry/bater-horas2",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    type: "Java backend",
    summary:
      "REST backend for time tracking with a legacy Java stack, useful as a backend-only architecture story rather than a polished live demo.",
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/osmarpetry/horas",
      },
    ],
  },
  {
